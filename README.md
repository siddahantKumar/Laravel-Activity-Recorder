...
## About Project (Laravel-Activity-Recorder)

INSTALL:

command use for install the package is given below:

composer require spatie/laravel-activitylog

and further process of setup and install the package is given below in mentioned link:


https://spatie.be/docs/laravel-activitylog/v3/installation-and-setup
